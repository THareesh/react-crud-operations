...
export default class Home extends Component {
    ...
    handleSubmitForm = event => {
        ...
        Axios.post("https://react-redux1-2cfe9.firebaseio.com/userdata.json", data)
            .then(res => {
                console.log("sucess");
    ...
    handleDelete = (key) => {
        Axios.delete(`https://react-redux1-2cfe9.firebaseio.com/userdata/${key}.json`)
            .then(res => {
    ...
    submitUpdatedData = (event) => {
        ...
        Axios.put(`https://react-redux1-2cfe9.firebaseio.com/userdata/${this.state.idToUpdate}.json`, data)
            .then(res => {
